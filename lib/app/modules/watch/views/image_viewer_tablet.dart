...
import '../../../widgets/performance/optimized_image.dart';
...
class ImageViewerTablet extends GetView<WatchController> {
  ...
  Widget _buildBody(BuildContext context, LayoutController layoutController) {
    return Obx(() {
      ...
      if (post == null) {
        return const Center(child: Text("ARTIFACT_NOT_FOUND", style: TextStyle(color: Colors.white24)));
      }
      ...
      return Stack(
        children: [
          ...
          Positioned.fill(
            child: _buildImmersiveImageHero(post),
          ),
  ...
  Widget _buildImmersiveImageHero(PostModel post) {
    return Container(
      color: Colors.black, 
                ...
                sliver: SliverList.list(
                  children: [
                    ...
                    if (post.parentId != null) ...[
                      GestureDetector(
                        onTap: () => Get.toNamed<void>('/view/${post.parentId}'),
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.account_tree_outlined, color: Colors.amber, size: 14),
                    ...
                    if (post.projectFileUrl == null || post.projectFileUrl!.isEmpty) ...[
                        const SizedBox(height: 12),
                        _buildActionCapsule(context, 'share'.tr.toUpperCase(), Icons.share_rounded, () {}, layoutController),
                    ],
                    const SizedBox(height: 32),
                ...
                children: [
                  ...
                  if (controller.post.value?.coAuthorIds?.isNotEmpty ?? false) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: layoutController.primaryColor.withValues(alpha: 0.2),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: Text(
                        "+ ${controller.post.value!.coAuthorIds!.length} CO-AUTHORS",
                        style: GoogleFonts.plusJakartaSans(
